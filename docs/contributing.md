...
Need something? Found a bug? Or just have a brilliant idea? Head to the [Issues](https://github.com/Bundabrg/DebugScanner/issues) and create new one.
...
```shell
git clone https://github.com/Bundabrg/DebugScanner
cd DebugScanner
mvn clean package
```
